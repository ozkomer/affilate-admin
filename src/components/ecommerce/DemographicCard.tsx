...
export default function DemographicCard() {
  ...
  const displayData = showCities ? cities : countries;
    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
      <div className="flex justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
            {showCities ? "Şehir bazında tıklama sayıları" : "Ülke bazında tıklama sayıları"}
          </p>
        </div>
        ...
        <div className="relative inline-block">
          ...
          >
            ...
            >
              {showCities ? "Ülkelere Göre" : "Şehirlere Göre"}
            </DropdownItem>
          </Dropdown>
        </div>
      </div>
      ...
      <div className="space-y-5">
        {loading ? (
          ...
          <div className="text-center py-8 text-gray-500 dark:text-gray-400">
            Henüz {showCities ? "şehir" : "ülke"} verisi yok
          </div>
        ) : (
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="block text-gray-500 text-theme-xs dark:text-gray-400">
                    {item.count.toLocaleString("tr-TR")} Tıklama
                  </span>
                </div>
              </div>
