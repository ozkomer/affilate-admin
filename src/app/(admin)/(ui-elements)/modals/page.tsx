...
export const metadata: Metadata = {
  title: "Next.js Modals | EnesOzen AffilatePro - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for EnesOzen AffilatePro - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
