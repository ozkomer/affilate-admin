...
export const metadata: Metadata = {
  title: "Next.js Buttons | EnesOzen AffilatePro - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for EnesOzen AffilatePro - Next.js Tailwind CSS Admin Dashboard Template",
};
