...
export const metadata: Metadata = {
  title: "Next.js Avatars | EnesOzen AffilatePro - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for EnesOzen AffilatePro - Next.js Tailwind CSS Admin Dashboard Template",
};
