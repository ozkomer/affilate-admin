...
export const metadata: Metadata = {
  title: "Next.js Badge | EnesOzen AffilatePro - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for EnesOzen AffilatePro - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
